...
KlarkModule(module, 'krkServer', function($http, krkLogger) {
  ...
  function start(app, config) {
    ...
    function onError(error) {
      ...
      switch (error.code) {
        case 'EACCES':
          krkLogger.error(bind + ' requires elevated privileges');
          process.exit(1);
          break;
        case 'EADDRINUSE':
          krkLogger.error(bind + ' is already in use');
          process.exit(1);
          break;
        default:
          throw error;
    ...
    function onListening() {
      ...
      var bind = typeof addr === 'string'
        ? 'pipe ' + addr
        : 'port ' + addr.port;
      krkLogger.info('Listening on ' + bind);
    }
  }
});
